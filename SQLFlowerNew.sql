...
(
	...
	INNER JOIN @Flowers f3 ON f2.Name <> f3.Name and f1.Name <> f3.Name
	INNER JOIN @Flowers f4 ON f3.Name <> f4.Name and f2.Name <> f4.Name and f1.Name <> f4.Name
	INNER JOIN @Flowers f5 ON f4.Name <> f5.Name and f3.Name <> f5.Name and f2.Name <> f5.Name and f1.Name <> f5.Name
)
